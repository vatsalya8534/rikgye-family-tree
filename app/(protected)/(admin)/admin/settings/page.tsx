      ...
      <Tabs defaultValue="general">
        ...
        <TabsContent value="mail">
          <Card className="p-6 space-y-6 max-w-3xl">
            ...
            <Button onClick={handleSave}>Save Mail Settings</Button>
          </Card>
        </TabsContent>
          ...
          <Card className="p-6 space-y-6 max-w-3xl">
            <Accordion type="multiple">
              <AccordionItem value="create">
                <AccordionTrigger>Create Template</AccordionTrigger>
                ...
                <AccordionContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Editor
                      ...
                      init={{
                        ...
                        toolbar:
                          "undo redo | blocks | bold italic underline | alignleft aligncenter alignright | bullist numlist | link image | codesample | code | fullscreen",
                        block_formats:
                  ...
                  <Button onClick={createTemplate} disabled={templateLoading}>
                    {templateLoading ? (
                      <>
                        <Loader2 className="animate-spin mr-2" />
                        Creating
            ...
            <div className="space-y-2">
              ...
              <Editor
               ...
               value={editTemplateDescription}
                onEditorChange={(content) => {
                  setEditTemplateDescription(content);
                }}
                init={{
                  height: 300,
                  menubar: false,
